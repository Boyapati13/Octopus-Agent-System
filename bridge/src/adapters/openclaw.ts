/**
 * OpenClawAdapter stub — full implementation in AgentDeck monorepo.
 */
...
export class OpenClawAdapter extends EventEmitter implements AgentAdapter {
  constructor(_gatewayUrl?: string) { super(); }
  readonly capabilities: AgentCapabilities = {
    supportsInterrupt: false, supportsPermission: false, supportsModeSwitch: false,
    supportsVoiceInput: false, supportsMultipleOptions: false, agentType: 'openclaw',
  };
