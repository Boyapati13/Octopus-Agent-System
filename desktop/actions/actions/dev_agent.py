...
from core.text_llm import complete as _llm_complete  # noqa: E402
...
JSON:"""
    ...
    try:
        raw = _strip_fences(_llm_complete(prompt, max_tokens=1024, timeout=60))
...
Code for {file_path}:"""
    ...
    try:
        code = _strip_fences(_llm_complete(prompt, max_tokens=3000, timeout=90))
...
Fixed code for {fix_path}:"""
        ...
        try:
            fixed = _strip_fences(_llm_complete(prompt, max_tokens=3000, timeout=90))
