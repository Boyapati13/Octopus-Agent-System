...
TOOL_DECLARATIONS = [
    ...
    },
    {
        "name": "octopus_agent",
        "description": (
            "Run a complex coding, review, security-audit, or multi-file task through the "
            "Octopus multi-agent pipeline (Cortex → Architect → Forge → Reviewer → SecurityReviewer → Probe). "
            "Use this for: writing/refactoring/reviewing multi-file projects, security scans, "
            "generating tests, updating documentation, or any task that needs the full agent chain. "
            "For quick Q&A or simple searches, use quick=true."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "task": {
                    "type": "STRING",
                    "description": "The full task description for the agent pipeline"
                },
                "project_root": {
                    "type": "STRING",
                    "description": "Optional: absolute path to the codebase to work on"
                },
                "quick": {
                    "type": "BOOLEAN",
                    "description": "If true, use fast Q&A mode instead of full pipeline"
                },
            },
            "required": ["task"]
        }
